...
const SkillsList = () => {
    ...
    const skills = {
        "What technologies do I use?": [
            "I currently work with technologies like React, Next.js, Vue.js, Astro, Tailwind, Bootstrap and other libraries and frameworks for the frontend, and for the backend I work with Node.js, Express, MongoDB, Firebase, among others.",
        ],
        "My Experience": [
            "I have experience working in startups and tech consultancies, developing and building websites from Figma designs. For this, I use frontend technologies like Astro and React, along with Tailwind CSS and other libraries and frameworks for styling and interface optimization.",
        ]
    };
